...
function createMenuItem(name, cost, category) {
  let Object = { name: name, cost: cost, category: category };
  return Object;
}

/* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */

//console.log(createMenuItem("pbj", 3, "sandwhich"));
//console.log(createMenuItem("hamburg", 199, "borg"));
//console.log(createMenuItem("justice", 96, "best serverd cold"));
